...
class GithubPopularRepos extends Component {
  ...
  getRepositories = async () => {
    ...
    if (response.ok) {
      ...
      const updatedData = fetchedData.popular_repos.map(eachRepoitory => ({
        id: eachRepoitory.id,
        imageUrl: eachRepoitory.avatar_url,
        name: eachRepoitory.name,
        starsCount: eachRepoitory.stars_count,
        forksCount: eachRepoitory.forks_count,
        issuesCount: eachRepoitory.issues_count,
      }))
      this.setState({
